...
const versionsObj: VersionsObj = {
    ...
    8: {
        versionNumber: 'v 2.4.0',
        versionText: [
            '- Добавлен подсчет времени для каждого примера',
            '- Добавлены пользовательские сиды для сессии',
            '- Добавлена функция повтора сессии',
            '- Добавлена индикация самого быстрого и медленного примера',
            '- Добавлена функция сравнения времени при повторной сессии',
            '- Добавлена функция генерации аватаров',
            '- Исправлена ошибка с неверным подсчетом очков при переключении вкладки',
            '- Добавлены новые анимации для личного кабинета',
            '- Добавлена тема matrix',
            '- Исправлены мелкие ошибки и баги',
        ],
    },
};
